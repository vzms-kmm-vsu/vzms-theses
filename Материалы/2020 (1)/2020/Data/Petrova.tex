\begin{center}
    {\bf ОБ ОБОСНОВАНИИПРИБЛИЖЁННЫХ МЕТОДОВ РЕШЕНИЯ ЗАДАЧ ВЫПУКЛОГО ПРОГРАММИРОВАНИЯ}

    {\it Л.П. Петрова, И.Н. Прядко}

    (Воронеж, ВГУ; {\it lpp1950@mail.ru, pryadko\_irina@mail.ru})
\end{center}

\addcontentsline{toc}{section}{Петрова Л.П., Прядко И.Н.}
