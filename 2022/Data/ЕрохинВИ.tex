...
Движение космического объекта (КО) в поле тяготения Земли в рамках кеплеровской модели невозмущенного движения описывается следующими уравнениями [1]:
...
расcчитаные в соотвествии с \eqref{eq1}--\eqref{eq8} прямоугольные АГЭСК-координаты КО в моменты времени
${t_{i,j}}$,
