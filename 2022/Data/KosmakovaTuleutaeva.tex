...
\begin{cases}
\tilde{f}(y,t) \in L_{2}(0,T;H^{-1}(\Omega))\Leftrightarrow\\
\Leftrightarrow f(x,t_{1}) \in L_{2}(0,T_{1};H^{-1}(\Omega_{t_{1}})),\\
...
W_n\!=\!\left\{ v\in L_{2}\!\left(\frac{1}{n},T_{1};\,H_0^{1}(\Omega_{t_{1}}^{n})\!\right); \;
\frac{\partial v}{\partial t_1}\!\in
 L_{2}\!\left(\frac{1}{n},T_{1};\,H^{-1}
