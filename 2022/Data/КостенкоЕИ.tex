...
\paragraph{Определение~1} {\it Пусть $f\in L_2(0,T;V^{-1})$. Cлабым решением задачи (1)--(4) называется функция $v\in W_1=\{v\in L_2(0, T; V^1)\cap L_\infty(0, T; V^0), \quad v'\in L_{4/3}(0, T; V^{-1})\}$, удовлетворяющая при любой $\varphi\in V^1$  и п.в. $t\in (0,T)$ тождеству
 $$
...
$$
  и начальному условию $v(0)=v_0$. Здесь $z$~---РЛП, порожденный $v$.}
