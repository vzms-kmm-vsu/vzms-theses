...
\vzmstitle[
	...
	Развитие метода регуляризации для сингулярно возмущенной задачи Коши с <<простой>> рациональной точкой поворота для параболического уравнения
}
...
Согласно методу регуляризации, введем расширенную функцию
