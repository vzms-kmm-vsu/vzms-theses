...
%To avoid having author-defined subsections in the ToC
...
\includepdf{second_page.pdf}

% Тезисы отсортированы по алфавиту и хранятся в файле theses.tex. Подключаем их оттуда.
% Команда \thesis делает много хорошего
