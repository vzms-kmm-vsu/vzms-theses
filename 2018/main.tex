...
%\let\varvzmsauthor\relax

%\newcommand{\vzmsauthor}[2]{
%	\ifthenelse{
%		\equal{\varvzmsautor}{}
%	}{
%		\renewcommand{\varvzmsauthor}{#1~#2}
%	}{
%		\renewcommand{\varvzmsauthor}{\varvzmsauthor, #1~#2}
%	}
%}

%\newcommand{\vzmsauthor}[2]{%
%	\ifdefined\varvzmsauthor
%		\def\varvzmsauthor{\varvzmsauthor, #1~#2}
%	\else
%		\def\varvzmsauthor{#1~#2}
%	\fi
%}
...
\newcommand{\vzmsflushauthors}{
	\ifthenelse{
		...
		\edef\varvzmsflushedauthors{\varvzmsflushedauthors \\ \varvzmsauthor}
	}
	\def\varvzmsauthor{}
}
