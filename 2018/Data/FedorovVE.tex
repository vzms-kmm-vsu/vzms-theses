\vzmstitle{ОБРАТНАЯ ЗАДАЧА ДЛЯ  УРАВНЕНИЯ В БАНАХОВОМ ПРОСТРАНСТВЕ, НЕ РАЗРЕШИМОГО ОТНОСИТЕЛЬНО ПРОИЗВОДНОЙ РИМАНА--ЛИУВИЛЛЯ}

\vzmsauthor{Федоров}{В.\,Е.}
\vzmsauthor{Нажимов}{Р.\,Р.}

\vzmsinfo{Челябинск; {\it kar@csu.ru, goldenboy454@mail.ru}}
