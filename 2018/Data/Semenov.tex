\vzmstitle[\footnote{Работа выполнена при финансовой поддержке ГФФИУ (проект \No\ F74/24921) и  МОНУ (проект \No\ 0116U004777)}]
{ \bf  МОДИФИЦИРОВАННЫЕ ЭКСТРАГРАДИЕНТНЫЕ МЕТОДЫ ДЛЯ ВАРИАЦИОННЫХ НЕРАВЕНСТВ}
