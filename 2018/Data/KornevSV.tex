\vzmstitle{ \bf  On the method of generalized multivalent guiding functions in the periodic problem for random differential equations}

\vzmsauthor{{Kornev}}{S.\, V.}

\vzmsinfo{Voronezh, Russia; {\it kornev$\_$vrn@mail.ru} )

\vzmsauthor{{Obukhovskii}}{V.\, V.}

\vzmsinfo{Voronezh, Russia; {\it valerio-ob2000@mail.ru} )

\vzmsauthor{{Zecca}}{P.}

\vzmsinfo{Firenze, Italy; {\it pietro.zecca@unifi.it} )


\addcontentsline{toc}{section}{Kornev S.V., Obukhovskii V.V., Zecca P. \dotfill}
