...
(t)} },
\]
определенное, например, на функциях
...
решение, принадлежащее пространству $H_{r,\gamma ,\alpha .q}^s $, причем
...
Рассмотрим теперь задачу (\ref{eq4700}), (3), (\ref{eq4702}). Введем наряду с пространствами
...
\,\,\,j = 1,2,...,r_1 $ нулем при$y < 0$ справедливы включения $F - Av_0 \in
...
$\hat {H}_{r,\gamma ,\alpha .q}^s (R_{ + + }^{n + 1} )$, причем справедлива
априорная оценка
\[
