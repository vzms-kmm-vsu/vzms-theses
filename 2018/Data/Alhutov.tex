...
\addcontentsline{toc}{section}{Алхутов Ю.А., Сурначёв М.Д.}
...
$$
1<\alpha\leq p(x)\leq \beta<\infty, \quad \text{для почти всех}\quad x\in \mathbb{R}^n %\eqno{(2)}
$$
...
$$
|p(x)-p(x_0)|\leq \frac{C}{ \ln \frac{1}{|x-x_0|}},\quad \text{при} \quad |x-x_0|\leq \frac{1}{2}. %\eqno{(6)}
$$
