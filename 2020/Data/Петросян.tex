\vzmstitle[\footnote{Исследование выполнено при финансовой поддержке РФФИ в рамках научного проекта № 19-31-60011.}]{О РАЗРЕШИМОСТИ ПЕРИОДИЧЕСКОЙ ЗАДАЧИ ДЛЯ ПОЛУЛИНЕЙНОГО ДИФФЕРЕНЦИАЛЬНОГО ВКЛЮЧЕНИЯ ДРОБНОГО ПОРЯДКА С ОТКЛОНЯЮЩИМСЯ АРГУМЕНТОМ }
\vzmsauthor{Петросян}{Г.\,Г.}
\vzmsinfo{Воронеж, ВГУИТ, ВГПУ; {\it garikpetrosyan@yandex.ru}}
\vzmscaption

В работе для полулинейного функционально"=дифференциального включения в сепарабельном банаховом пространстве $E$ следующего вида
$$
